...
<body>
    ...
    <script async defer src="{{ url('/public/front/js/bootstrap.bundle.min.js') }}"></script>
    <script async defer src="{{ url('/public/front/js/swiper.min.js') }}"></script>
    <script async defer src="{{ url('/public/front/js/jquery.ajaxchimp.min.js') }}"></script>
    <script async defer src="{{ url('/public/front/js/bootstrap-select.min.js') }}"></script>
    <script async defer src="{{ url('/public/front/js/jquery.magnific-popup.min.js') }}"></script>
    <script async defer src="{{ url('/public/front/js/jquery.validate.min.js') }}"></script>
    <script async defer src="{{ url('/public/front/js/wow.js') }}"></script>
    <script async defer src="{{ url('/public/front/js/jquery.appear.min.js') }}"></script>

    <!-- template js -->
    <script async defer src="{{ url('/public/front/js/theme.js') }}"></script>
