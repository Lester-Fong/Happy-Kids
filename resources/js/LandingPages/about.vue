      ...
      <div class="container">
        <div class="team-about__top mt-60">
          <div class="row">
            ...
            <!-- /.col-md-12 col-lg-6 -->
            <div class="col-md-12 col-lg-4">
              <p class="team-about__top-text">Tincidunt elit magnis nulla facilisis sagittis is maecenas. Sapien nunced amet ultrices, dolores sit ipsum velit purus aliquet, massa fringilla leo orci ipsum dolor sit.</p>
            </div>
            <!-- /.col-md-12 col-lg-6 -->
            <div class="col-md-12 col-lg-4">
              <p class="team-about__top-text">Sapien nunced amet ultrices, dolores sit ipsum velit purus aliquet, massa fringilla leo orci. Lorem ipsum dolor sit amet. consectetur adipisi cing elit dolo.</p>
            </div>
            <!-- /.col-md-12 col-lg-6 -->
          </div>
          <!-- /.row -->
