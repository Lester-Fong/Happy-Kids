  ...
  <div>
    ...
    <section class="page-header">
      ...
      <div class="container">
        ...
        <ul class="thm-breadcrumb list-unstyled dynamic-radius">
          ...
          <li>-</li>
          <li><span>Scholarship Program</span></li>
        </ul>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 col-lg-6">
            <h3>Trimex FAC Scholarsip Program</h3>
            <p>The Trimex Happy Kids Foundation Scholars program gives rising leaders from the United States and around the world who are already making a difference in their communities the opportunity to take their work to the next level through an immersive curriculum that brings together academic, skills-based, and hands-on learning.</p>
          </div>
          <!-- /.col-md-12 -->
          <div class="col-md-12 col-lg-6">
            <img src="front/assets/images/events/event-details-1-1.jpg" alt="" class="img-fluid" />
          </div>
          <!-- /.col-md-12 -->
        </div>
        <!-- /.row -->
    ...
    <section class="pt-120 pb-120 bg-light">
      <div class="w-70 mx-auto">
        <h1 class="text-center mb-5">About the Scholars Program</h1>
        <p>
        ...
        <div class="team-3-col">
          <div class="team-card text-center content-bg-1">
            <div class="team-card__image">
              <img src="front/assets/images/team/team-1-1.jpg" alt="" />
            </div>
            <!-- /.team-card__image -->
