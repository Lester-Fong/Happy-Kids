    ...
    <section class="event-details pt-120">
      <div class="container">
        ...
        <div class="row">
          ...
          <!-- /.col-md-12 -->
          <div class="col-md-12 col-lg-6">
            <img :src="`/uploads/pages/program_/scholarship-program/${pages.description?.program_image_webp}`" :alt="pages?.description?.program_intro_title" class="img-fluid program_img" />
          </div>
          <!-- /.col-md-12 -->
        </div>
        <!-- /.row -->
